            ...
            <div class="cmg cmg-1" style="margin-top:30px;">
                ...
                <div class="cmg cmg-1">
                    ...
                    <div class="btn-group">
                        ...
                        <a href="{{url('user/mining/buy-haspower')}}" class="btn btn-primary">Buy Haspower</a>
                        <a href="{{url('user/mining/dogecoin')}}" class="btn btn-primary">Mine Dogecoin</a>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="cmg cmg-1" style="margin-top:30px;">
            ...
            <div class="cmg cmg-1">
                ...
                <a href="{{url('user/withdrawal')}}" class="btn btn-primary">Withdraw</a>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="cmb-upgrade">
                ...
                <a href="{{url('user/mining/buy-hashpower')}}" role="button" class="btn btn-warning order-hp-dash pull-right"><span class="fa fa-bolt"></span>Buy Hashpower</a>
